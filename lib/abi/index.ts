...
export const eventsAbi = [
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'stakingType',
        internalType: 'enum Events.StakingType',
        type: 'uint8',
        indexed: true,
      },
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'tradeType',
        internalType: 'enum Events.TradeType',
        type: 'uint8',
        indexed: true,
      },
      {
...
export const iSpaceAbi = [
  {
    type: 'function',
    inputs: [
      { name: 'minTokenAmount', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'buy',
    outputs: [
      {
...
export const iSpaceFactoryAbi = [
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'feePercent', internalType: 'uint256', type: 'uint256' },
        ],
      },
    ],
    stateMutability: 'view',
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'spaceAddress', internalType: 'address', type: 'address' },
    ],
    name: 'isSpace',
    outputs: [{ name: '', internalType: 'bool', type: 'bool' }],
    stateMutability: 'nonpayable',
...
export const spaceAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: '_appId', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct Share.Order[]',
        type: 'tuple[]',
        components: [
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct Share.VestingInfo[]',
        type: 'tuple[]',
        components: [
          { name: 'beneficiary', internalType: 'address', type: 'address' },
  ...
  },
  {
    ...
    name: 'member',
    outputs: [
      { name: 'planIndex', internalType: 'uint8', type: 'uint8' },
      { name: 'subscriptionIndex', internalType: 'uint256', type: 'uint256' },
      { name: 'subscriptionIncome', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    name: 'staking',
    outputs: [
      { name: 'yieldStartTime', internalType: 'uint256', type: 'uint256' },
      { name: 'yieldAmount', internalType: 'uint256', type: 'uint256' },
      { name: 'yieldReleased', internalType: 'uint256', type: 'uint256' },
