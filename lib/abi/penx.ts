...
export const creationFactoryAbi = [
  {
    type: 'constructor',
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'mark', internalType: 'string', type: 'string', indexed: false },
    ],
    name: 'Minted',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'space', internalType: 'address', type: 'address' },
    ],
    name: 'create',
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: '_creatorFeePercent', internalType: 'uint256', type: 'uint256' },
      { name: '_curatorFeePercent', internalType: 'uint256', type: 'uint256' },
...
export const iCreationFactoryAbi = [
  {
    type: 'function',
    inputs: [
      { name: 'uri', internalType: 'string', type: 'string' },
...
export const iSpaceAbi = [
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'mintPastDuration', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'distributeSubscriptionRewards',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    type: 'function',
    inputs: [{ name: 'account', internalType: 'address', type: 'address' }],
    name: 'getCurationUser',
    outputs: [
      {
        name: '',
        internalType: 'struct CurationUser',
        type: 'tuple',
        components: [
          { name: 'curator', internalType: 'address', type: 'address' },
          { name: 'rewards', internalType: 'uint256', type: 'uint256' },
  ...
  {
    type: 'function',
    inputs: [{ name: 'code', internalType: 'bytes32', type: 'bytes32' }],
    name: 'getCurationUserByCode',
    outputs: [
      {
        name: '',
        internalType: 'struct CurationUser',
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'realized', internalType: 'uint256', type: 'uint256' },
          { name: 'checkpoint', internalType: 'uint256', type: 'uint256' },
        ],
      },
    ],
    ...
    outputs: [
      {
        ...
        components: [
          {
            name: 'memberCountBreakpoint',
            internalType: 'uint256',
            type: 'uint256',
          },
          { name: 'rebateRate', internalType: 'uint256', type: 'uint256' },
        ],
      },
    ],
    stateMutability: 'view',
...
export const mockSpaceAbi = [
  ...
  },
  {
    ...
    outputs: [
      {
        name: 'info',
        internalType: 'struct MockSpace.BuyInfo',
        type: 'tuple',
        components: [
          { name: 'newX', internalType: 'uint256', type: 'uint256' },
          { name: 'newY', internalType: 'uint256', type: 'uint256' },
...
export const penTokenAbi = [
  ...
  { type: 'error', inputs: [], name: 'ReentrancyGuardReentrantCall' },
  { type: 'error', inputs: [], name: 'SponsorAmountIsZero' },
  { type: 'error', inputs: [], name: 'SponsorAmountTooLarge' },
  {
    type: 'error',
    inputs: [{ name: 'str', internalType: 'string', type: 'string' }],
    name: 'StringTooLong',
...
export const tipAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'uri', internalType: 'string', type: 'string', indexed: false },
      {
        name: 'tipperRewardPercent',
        internalType: 'uint256',
        type: 'uint256',
        indexed: false,
      },
    ],
    name: 'TipRequestExecuted',
  },
  {
    type: 'event',
    anonymous: false,
    ...
    name: 'TipperRewardPercentUpdated',
  },
  {
    type: 'function',
    inputs: [
      { name: 'requestId', internalType: 'uint256', type: 'uint256' },
      { name: 'reasonCode', internalType: 'string', type: 'string' },
    ],
    name: 'cancelTipRequest',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'requestId', internalType: 'uint256', type: 'uint256' },
      { name: 'allocationCap', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'executeTipRequest',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct Tip.RequestInfo[]',
        type: 'tuple[]',
        components: [
          { name: 'requestId', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct Tip.Request',
        type: 'tuple',
        components: [
          { name: 'tipper', internalType: 'address', type: 'address' },
          { name: 'receiver', internalType: 'address', type: 'address' },
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct Tip.Tipper',
        type: 'tuple',
        components: [
          { name: 'allocation', internalType: 'uint256', type: 'uint256' },
          { name: 'allocatedTime', internalType: 'uint256', type: 'uint256' },
          { name: 'allocationCap', internalType: 'uint256', type: 'uint256' },
        ],
      },
    ],
