...
const headingVariants = cva('relative mb-1', {
  variants: {
    variant: {
      h1: 'mt-[1em] pb-1 font-heading text-4xl font-bold',
      h2: 'mt-[0.8em] pb-px font-heading text-2xl font-semibold tracking-tight',
      h3: 'mt-[0.7em] pb-px font-heading text-xl font-semibold tracking-tight',
      h4: 'mt-[0.6em] font-heading text-lg font-semibold tracking-tight',
