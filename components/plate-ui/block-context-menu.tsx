...
import { BlockStyleDialog, useBlockStyleDialog } from './block-style-dialog'
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuGroup,
...
export function BlockContextMenu({ children }: { children: React.ReactNode }) {
  ...
  const { setState } = useBlockStyleDialog()
          ...
          <ContextMenuGroup>
            ...
            <ContextMenuSub>
              ...
              <ContextMenuSubContent className="w-48">
                ...
                <ContextMenuItem
                  onClick={() => handleTurnInto(HEADING_KEYS.h1)}
                >
                  Heading 1
                </ContextMenuItem>
                <ContextMenuItem
                  onClick={() => handleTurnInto(HEADING_KEYS.h2)}
                >
                  Heading 2
                </ContextMenuItem>
                <ContextMenuItem
                  onClick={() => handleTurnInto(HEADING_KEYS.h3)}
                >
                  Heading 3
                </ContextMenuItem>
                <ContextMenuItem
