...
export function SiteItem({ site }: Props) {
  ...
  return (
    <Link
      ...
      target="_blank"
      className={cn(
        'flex items-center justify-between p-5 gap-3 bg-background/30 hover:scale-105 cursor-pointer transition-all dark:bg-foreground/5 border border-foreground/7',
